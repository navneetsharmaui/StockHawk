...
import tech.stockhawk.data.QuoteColumns;
import tech.stockhawk.data.QuoteProvider;
import tech.stockhawk.rest.QuoteCursorAdapter;
import tech.stockhawk.rest.RecyclerViewItemClickListener;
import tech.stockhawk.rest.Utils;
import tech.stockhawk.service.StockIntentService;
import tech.stockhawk.service.StockTaskService;
import tech.stockhawk.stock_widget.StockQuoteWidget;
import tech.stockhawk.touch_helper.SimpleItemTouchHelperCallback;
...
//                                        toast.show();
    ...
    private void updateStocksWidget(){
        ...
        if(ids.length > 0) {
             ...
             * #{@link tech.stockhawk.widget.StockQuoteWidgetService.StockRVFactory} class.
             */
